...
public class Manager extends Employee {
	...
	public Manager(long employeeId, String employeeName, String employeeAdress, long empolyeePhone,
			double basicSalary) {
	...
	public void calculateTransportAllowance (double basicSalary) {
		...
		System.out.println("The Transport Allownace is : "+transportAllowance );
	}
	}
